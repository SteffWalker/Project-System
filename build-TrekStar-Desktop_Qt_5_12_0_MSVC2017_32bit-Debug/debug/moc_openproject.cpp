...
#include "../../TrekStar/openproject.h"
...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_OpenProject_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_OpenProject_t qt_meta_stringdata_OpenProject = {
    {
QT_MOC_LITERAL(0, 0, 11) // "OpenProject"
...
QT_INIT_METAOBJECT const QMetaObject OpenProject::staticMetaObject = { {
    &QDialog::staticMetaObject,
    qt_meta_stringdata_OpenProject.data,
    qt_meta_data_OpenProject,
    qt_static_metacall,
    nullptr,
    nullptr
} };
...
void *OpenProject::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_OpenProject.stringdata0))
