...
private:
    ...
    DoubleSidedDVD twoDVD = DoubleSidedDVD();
...
public:
    ...
    vector<FilmCrew> getCrew() const;
    void setCrew(const vector<FilmCrew> &value);
    SingleSidedDVD getSingleDVD() const;
    void setSingleDVD(const SingleSidedDVD &value);
    DoubleSidedDVD getTwoDVD() const;
    void setTwoDVD(const DoubleSidedDVD &value);
