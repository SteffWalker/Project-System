...
vector<FilmCrew> Project::getCrew() const
{
    return Crew;
}

void Project::setCrew(const vector<FilmCrew> &value)
{
    Crew = value;
}
...
DoubleSidedDVD Project::getTwoDVD() const
{
    return twoDVD;
}

void Project::setTwoDVD(const DoubleSidedDVD &value)
{
    twoDVD = value;
}
