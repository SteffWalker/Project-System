...
public:
    ...
    void setupUi(QDialog *NewProject)
    {
        ...
        cbStatus_np->setObjectName(QStringLiteral("cbStatus_np"));
        cbStatus_np->setGeometry(QRect(550, 50, 331, 31));
        txtSummary_np = new QTextEdit(NewProject);
        txtSummary_np->setObjectName(QStringLiteral("txtSummary_np"));
        ...
        deRelease_np->setObjectName(QStringLiteral("deRelease_np"));
        deRelease_np->setGeometry(QRect(100, 170, 331, 31));
        cbLanguage_np = new QComboBox(NewProject);
        cbLanguage_np->setObjectName(QStringLiteral("cbLanguage_np"));
        cbLanguage_np->setGeometry(QRect(550, 150, 331, 31));
        lblSales_np = new QLabel(NewProject);
        lblSales_np->setObjectName(QStringLiteral("lblSales_np"));
        ...
        summaryStar->setObjectName(QStringLiteral("summaryStar"));
        ...
        summaryStar_2->setObjectName(QStringLiteral("summaryStar_2"));
        ...
        lblTitleProjects_np->setObjectName(QStringLiteral("lblTitleProjects_np"));
    ...
    void retranslateUi(QDialog *NewProject)
    {
        ...
        label->setText(QApplication::translate("NewProject", "Add Project", Q_NULLPTR));
        cbLanguage_np->setCurrentText(QString());
        lblSales_np->setText(QApplication::translate("NewProject", "Sales:", Q_NULLPTR));
        lblStatus_np->setText(QApplication::translate("NewProject", "Status:", Q_NULLPTR));
        lblLocations_np->setText(QApplication::translate("NewProject", "Locations:", Q_NULLPTR));
        cmdClear_np->setText(QApplication::translate("NewProject", "Reset Changes", Q_NULLPTR));
        lblLanguage_np->setText(QApplication::translate("NewProject", "Language:", Q_NULLPTR));
        lblRelease_np->setText(QApplication::translate("NewProject", "Release:", Q_NULLPTR));
        lblRuntime_np->setText(QApplication::translate("NewProject", "Runtime:", Q_NULLPTR));
        lblGenre_np->setText(QApplication::translate("NewProject", "Genre:", Q_NULLPTR));
        NewProjectButton->setText(QApplication::translate("NewProject", "Create Project", Q_NULLPTR));
        cmdLocationAdd_np->setText(QApplication::translate("NewProject", "Add", Q_NULLPTR));
        cmdKeywordsAdd_np->setText(QApplication::translate("NewProject", "Add", Q_NULLPTR));
        lblKeywords_np->setText(QApplication::translate("NewProject", "Keywords:", Q_NULLPTR));
        lblSummary_np->setText(QApplication::translate("NewProject", "Summary:", Q_NULLPTR));
        titleStar->setText(QString());
        summaryStar->setText(QString());
        summaryStar_2->setText(QString());
        lblTitleProjects_np->setText(QApplication::translate("NewProject", "Title:", Q_NULLPTR));
        backButton->setText(QApplication::translate("NewProject", "Back", Q_NULLPTR));
    } // retranslateUi
